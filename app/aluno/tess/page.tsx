...
export default async function TessAlunoPage({ searchParams }: { searchParams: Promise<{ conversa?: string; tipo?: string; id?: string }> }) {
  ...
  return <TessChat role="aluno" conversas={dados.conversas} conversa={dados.conversa?.conversa ?? null} mensagens={dados.conversa?.mensagens ?? []} contexto={dados.contexto} />;
}